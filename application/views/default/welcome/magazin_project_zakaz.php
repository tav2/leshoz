		...
		<div class="row">
			<div class="col-md-12">
				<div class="product-meta">
					<h1 class="product-title">Все проекты на заказ</h1>
					<ul class="product-breadcrumb">
						<li><a href="javscript:;">Главная</a>
						</li>
						<li><a href="javscript:;">Разработка проектов</a>
						</li>
						<li class="current"><a href="javscript:;">Все</a>
						</li>
					</ul>
				</div>
			</div>
			<div class="col-md-9">
				<?php echo $api_get_project_zakaz;?>
			</div>
			<!-- .shop-navbar -->
			<div class="col-md-3">
				<div class="row">
